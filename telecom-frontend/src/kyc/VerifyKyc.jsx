...
function VerifyKyc() {
  ...
  const handleVerify = async () => {
    if (!kycId.trim()) {
      alert("Please enter a KYC ID");
      return;
    }
    try {
      setLoading(true);
      await api.post(`/kyc/verify/${kycId}`);
    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        <div style={styles.card}>
          ...
          <h2 style={styles.heading}>Verify KYC</h2>
          <p style={styles.subheading}>Enter your KYC ID to verify your documents</p>

          <label style={styles.label}>KYC ID</label>
          <input
            type="text"
